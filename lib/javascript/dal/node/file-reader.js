(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'promisify-node', 'path', 'fs', 'rustie'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('promisify-node'), require('path'), require('fs'), require('rustie'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.promisify, global.path, global.fs, global.rustie);
    global.fileReader = mod.exports;
  }
})(this, function (exports, _promisifyNode, _path, _fs, _rustie) {
  'use strict';
